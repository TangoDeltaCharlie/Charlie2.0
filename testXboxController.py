...
if __name__ == '__main__':
    ...
    def lTriggerPressed(value):
        print("LT {}".format(value))


    def rTriggerPressed(value):
    ...
    def dpadUpPressed(value):
        if value == 0:
            print("dpadUp Pressed")


    def dpadDownPressed(value):
        if value == 0:
            print("dpadDown Pressed")


    def dpadLeftPressed(value):
        if value == 0:
            print("dpadLeft Pressed")


    def dpadRightPressed(value):
        if value == 0:
            print("dpadRight Pressed")


    def startPressed(value):
        if value == 0:
            print("Start Pressed")


    def backPressed(value):
        if value == 0:
            print("Back Pressed")


    def leftThumbPressed(value):
        if value == 0:
            print("LeftThumb Pressed")


    def rightThumbPressed(value):
        if value == 0:
    ...
    xboxCont.setupControlCallback(xboxCont.XboxControls.LTRIGGER, lTriggerPressed)
    xboxCont.setupControlCallback(xboxCont.XboxControls.RTRIGGER, rTriggerPressed)

    xboxCont.setupControlCallback(xboxCont.XboxControls.A, aPressed)
    xboxCont.setupControlCallback(xboxCont.XboxControls.B, bPressed)
    xboxCont.setupControlCallback(xboxCont.XboxControls.X, xPressed)
    xboxCont.setupControlCallback(xboxCont.XboxControls.Y, yPressed)
    xboxCont.setupControlCallback(xboxCont.XboxControls.DPAD, dpadUpPressed)
    xboxCont.setupControlCallback(xboxCont.XboxControls.DPAD, dpadDownPressed)
    xboxCont.setupControlCallback(xboxCont.XboxControls.DPAD, dpadLeftPressed)
    xboxCont.setupControlCallback(xboxCont.XboxControls.DPAD, dpadRightPressed)
    xboxCont.setupControlCallback(xboxCont.XboxControls.START, startPressed)
    xboxCont.setupControlCallback(xboxCont.XboxControls.BACK, backPressed)
    xboxCont.setupControlCallback(xboxCont.XboxControls.LEFTTHUMB, leftThumbPressed)
    xboxCont.setupControlCallback(xboxCont.XboxControls.RIGHTTHUMB, rightThumbPressed)
    xboxCont.setupControlCallback(xboxCont.XboxControls.LB, lbPressed)
    xboxCont.setupControlCallback(xboxCont.XboxControls.RB, rbPressed)
    xboxCont.setupControlCallback(xboxCont.XboxControls.XBOX, xboxPressed)
