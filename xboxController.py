...
class XboxController(threading.Thread):
    ...
    """
    BUTTONCONTROLMAP = {PyGameButtons.DPADUP: XboxControls.DPAD,
                        PyGameButtons.DPADDOWN: XboxControls.DPAD,
                        PyGameButtons.DPADLEFT: XboxControls.DPAD,
                        PyGameButtons.DPADRIGHT: XboxControls.DPAD,
                        PyGameButtons.START: XboxControls.START,
                        PyGameButtons.BACK: XboxControls.BACK,
                        PyGameButtons.LEFTTHUMB: XboxControls.LEFTTHUMB,
                        PyGameButtons.RIGHTTHUMB: XboxControls.RIGHTTHUMB,
    ...
    def loadCallbacks(self):
        ...
        self.setupControlCallback(self.XboxControls.DPAD, self.dpadUpPressed)
        self.setupControlCallback(self.XboxControls.DPAD, self.dpadDownPressed)
        self.setupControlCallback(self.XboxControls.DPAD, self.dpadLeftPressed)
        self.setupControlCallback(self.XboxControls.DPAD, self.dpadRightPressed)
